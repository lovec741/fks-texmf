...
\begin{compactitem}
  ...
  \item Pokud si nejste jisti, jak velkou závorku použít, použijte zvětšující
    se závorky (\texinline|\(|, \texinline|\)|) -- jejich velikost se nastaví
    automaticky. Pokud se v~závorce vyskytuje zlomek, indexy apod., použijeme 
    zvětšující se	závorky vždy.
\end{compactitem}
...
\begin{texexampletab}
	...
	\texinline|$\trans$| & $\trans$ &
		symbol transponované matice\\\hline
  \texinline|$\f{g}{y,z}, \fz{g}{y,z},$|\ \texinline|$\fa{g}{y,z}{t}$| & $\f{g}{y,z}, \fz{g}{y,z}, \fa{g}{y,z}{t}$ &
		funkce $g$ s funkčními argumenty, v závorkách a se dvěma skupinami
    argumentů\\\hline
  \texinline|$\fp{g}{y,z}, \fpa{g}{y,z}{t}$| & $\fp{g}{y,z}, \fpa{g}{y,z}{t}$ &
		funkcionál $g$ s parametrem a s parametrem a argumentem\\\hline
\end{texexampletab}
...
Transponovanou matici $A\trans$ k matici $A$ vytvoříme 
záměnou řádků a sloupců
  \eq{
    A = 
    \begin{pmatrix}
      1 & 2 \\
