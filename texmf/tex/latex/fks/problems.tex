...
% reset optional parameters
    ...
    \probexpectedprecision{N/A}\probmachineresult{N/A}\probstudyyears{\fksMeta@problemDefaultStudyYears}%
...
\newcommand\problemtask{%
  ...
  \@LoadProblem{\thebatch}{\theproblem}{%
      \problem[\problemLetter{problem}: \@probname]{\lngopt{cs}{Úloha}\lngopt{en}{Problem} \problemnum{batch}{problem} \,\ldots{} \@probname{} \problemData{problem} \@probstudyyears \hfill {\normalfont\normalsize\problempoints}}%
