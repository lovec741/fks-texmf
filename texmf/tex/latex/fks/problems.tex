...
\newcommand\problemtask{%
  ...
  \@LoadProblem{\thebatch}{\theproblem}{%
      \problem[\metaprobletter{problem}: \@probname]{\lngopt{cs}{Úloha}\lngopt{en}{Problem} \problemnum{batch}{problem} \,\ldots{} \@probname{} \problemData{problem} \hfill {\normalfont\normalsize\problempoints}}%
...
\newcommand\@probstudyyears{\fksMeta@problemDefaultStudyYears}
