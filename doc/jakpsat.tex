...
\input{"fykos27/problems/problem1-7"} % nahradit souborem s úlohou
...
Nam sodales sem in egestas iaculis.
\end{texexample}
...
\begin{compactitem}
    ...
    zarovnat, dáme \verb|&|.
    \item Blokovou matematiku odsazujeme tabulátorem pro lepší čitelnost.
...
pomocí \texinline|e|. Chceme-li psát samostatně jednotku, využijeme příkaz 
\texinline|\jd{}|.
...
$\varphi = "(0.7687\pm 0.0003) arcsec"$, \\
vzestup o~$"13.2 \%"$, \\
rychlost v $\jd{m.s^{-1}}$.
\end{texexample}
...
(tedy vysází zlomek s veličinou v čitateli a jednotkou ve jmenovateli), ale je pro použití v 
tabulkách, automaticky zarovnává popisek na střed sloupce. Pomocí nepovinných parametrů
...
způsobem). Překládáme příkazem \texttt{xelatex}.
...
\RequirePackage{csquotes} % uvozovky
\DeclareQuoteStyle{czech}{\quotedblbase}{\textquotedblleft}{\textquoteleft}{\textquoteright}
